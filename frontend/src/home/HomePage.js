    ...
    return(
        ...
        <div id="main">
            ...
            <div className="box">
                ...
                <div className="movie">
                <div className="movie-image"> <span className="play"><span className="name">X-MAN</span></span> <a href="#"><img  alt="" /></a> </div>
                </div>
                <div class="movie">
                <div class="movie-image"> <span className="play"><span className="name">SPIDER MAN 2</span></span> <a href="#"><img src="css/images/movie2.jpg" alt="" /></a> </div>
                </div>
                <div className="movie">
            ...
            <div className="box">
                ...
                <div className="movie">
                <div className="movie-image"> <span class="play"><span class="name">MAGNETO</span></span> <a href="#"><img src="css/images/movie8.jpg" alt="" /></a> </div>
                </div>
                <div className="movie">
                ...
                <div className="movie">
                <div className="movie-image"> <span className="play"><span className="name">EAGLE EYE</span></span> <a href="#"><img src="css/images/movie10.jpg" alt="" /></a> </div>
                </div>
                <div className="movie">
